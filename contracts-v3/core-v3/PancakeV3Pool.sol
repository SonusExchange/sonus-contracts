...
contract PancakeV3Pool is IPancakeV3Pool {
    ...
    /// @dev Prevents calling a function from anyone except the factory or its
    /// owner
    modifier onlyFactoryOrFactoryOwnerOrPairFeesV3() {
        require(msg.sender == factory || msg.sender == IPancakeV3Factory(factory).owner() || msg.sender == IPancakeV3Factory(factory).pairFeesV3());
        _;
    }
    ...
    function collectProtocol(
        ...
        uint128 amount0Requested,
        uint128 amount1Requested
    ) external override lock onlyFactoryOrFactoryOwnerOrPairFeesV3 returns (uint128 amount0, uint128 amount1) {
