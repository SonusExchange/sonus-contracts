...
contract PancakeV3Factory is IPancakeV3Factory {
    ...
    address public override pairFeesV3;
    ...
    /// @inheritdoc IPancakeV3Factory
    function setPairFeesV3(address _pairFeesV3) external override onlyOwner {
        emit PairFeesV3Changed(pairFeesV3, _pairFeesV3);
