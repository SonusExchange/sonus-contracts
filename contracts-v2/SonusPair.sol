...
// The base pair of pools
contract SonusPair is IERC20, IPair, Reentrancy {
    ...
    constructor() {
        factory = msg.sender;
        (address _token0, address _token1) = IFactory(msg.sender)
            .getInitializable();
        ...
        swapFee = IFactory(msg.sender).getFee();
    ...
    function mint(address to) external override lock returns (uint liquidity) {
        ...
        require(liquidity > 0, "SonusPair: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "SonusPair: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "SonusPair: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint _reserve0, uint _reserve1) = (reserve0, reserve1);
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "SonusPair: INSUFFICIENT_LIQUIDITY"
        );
        uint _balance0;
        uint _balance1;
        {
            ...
            (address _token0, address _token1) = (token0, token1);
            require(to != _token0 && to != _token1, "SonusPair: INVALID_TO");
        ...
        require(
            ...
            "SonusPair: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
            ...
            _balance0 = IERC20(_token0).balanceOf(address(this));
            _balance1 = IERC20(_token1).balanceOf(address(this));
            // The curve x*y for volatile pools
            require(
    ...
    function approve(
        ...
        require(
            spender != address(0),
            "SonusPair: Approve to the zero address"
        );
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "SonusPair: EXPIRED");
    ...
    function transferFrom(
        ...
        if (spender != src && spenderAllowance != type(uint).max) {
            require(
                ...
                "SonusPair: Insufficient allowance"
            );
            unchecked {
    ...
    function _transferTokens(address src, address dst, uint amount) internal {
        require(dst != address(0), "SonusPair: Transfer to the zero address");
        ...
        require(
            srcBalance >= amount,
            "SonusPair: Transfer amount exceeds balance"
        );
        unchecked {
