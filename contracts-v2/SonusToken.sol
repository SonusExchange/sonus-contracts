...
contract SonusToken is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    mapping(address => bool) public minters;
    /**
     * @notice Constructs the SONUS ERC-20 contract.
     */
    constructor() public ERC20("Sonus", "SONUS") {
    ...
    /**
     * @notice Operator mints SONUS to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of SONUS to mint to
